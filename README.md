...
Answer: 
There are some difference between var, let and const.. but the main differences are the following:
...
Answer:
spread operator mean using three dots in array or object. basically can be use spread operator to expand the array/object. Also usefull to copy, merge update array or object using spread operator. can be use in argument in function. 
